...
$pdf->Cell(0,5,'SMK N 2 BAWANG','0','1','C',false);
$pdf->SetFont('Arial','i',8);
$pdf->Cell(0,5,' Jl. Raya Mantrianom No.75 Bawang Banjarnegara, 53471','0','1','C',false);
$pdf->Cell(0,2,'Nomer Telpon, 5985018 - Email : Email : smkn2bawang@yahoo.co.id ','0','1','C',false);
$pdf->Ln(3);
...
if(@$_GET['data'] == "pengajar") {
	...
	$pdf->SetFont('Arial','B',11);
	$pdf->Cell(50,5,'Laporan Daftar Kelas, Letak Ruang, Wali dan Ketua Masing-masing Kelas di SMK N 2 BAWANG','0','1','L',false);
	$pdf->Ln(3);
